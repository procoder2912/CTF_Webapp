...
const getFlag = () =>{
  ...
  return (
    ...
    //       </div>
    //       <div>
    //         <a style={{ color: "white" }} href={zig} download="Zig.pcapng" target="_blank" rel='noreferrer'>
    ...
    <div className="popup-window">
      ...
      <div className='content attachment' >
        ...
        <div className="down-box">
          ...
          <div>
            <a style={{ color: "white" }} href={zig} download="Zig's Misery.pcapng" target="_blank" rel='noreferrer'>
